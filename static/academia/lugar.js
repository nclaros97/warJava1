/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:7:3.72
*/
gx.evt.autoSkip = false;
gx.define('academia.lugar', false, function () {
   this.ServerClass =  "academia.lugar" ;
   ...
   {
      this.AV12LugarId=gx.fn.getIntegerValue("vLUGARID",'.') ;
   ...
   this.e13035_client=function()
   {
      return this.executeServerEvent("ENTER", true, null, false, false);
   };
   this.e14035_client=function()
   {
   ...
   GXValidFnc[25]={ id:25 ,lvl:0,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:1,grid:0,gxgrid:null,fnc:this.Valid_Lugarid,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"LUGARID",gxz:"Z25LugarId",gxold:"O25LugarId",gxvar:"A25LugarId",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[30]={ id:30 ,lvl:0,type:"char",len:50,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"LUGARNOMBRE",gxz:"Z39LugarNombre",gxold:"O39LugarNombre",gxvar:"A39LugarNombre",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[35]={ id: 35, fld:"BTNTRN_ENTER",grid:0};
   GXValidFnc[36]={ id: 36, fld:"",grid:0};
   GXValidFnc[37]={ id: 37, fld:"BTNTRN_CANCEL",grid:0};
   GXValidFnc[38]={ id: 38, fld:"",grid:0};
   GXValidFnc[39]={ id: 39, fld:"BTNTRN_DELETE",grid:0};
   this.A25LugarId = 0 ;
   this.Z25LugarId = 0 ;
   this.O25LugarId = 0 ;
   this.A39LugarNombre = "" ;
   ...
   this.A39LugarNombre = "" ;
   this.Gx_mode = "" ;
   this.Events = {"e12032_client": ["AFTER TRN", true] ,"e13035_client": ["ENTER", true] ,"e14035_client": ["CANCEL", true]};
   this.EvtParms["ENTER"] = [[{postForm:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV12LugarId',fld:'vLUGARID',pic:'ZZZ9',hsh:true}],[]];
   this.EvtParms["REFRESH"] = [[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV12LugarId',fld:'vLUGARID',pic:'ZZZ9',hsh:true},{av:'A25LugarId',fld:'LUGARID',pic:'ZZZ9'}],[]];
   ...
   this.setVCMap("AV12LugarId", "vLUGARID", 0, "int", 4, 0);
   this.setVCMap("Gx_mode", "vMODE", 0, "char", 3, 0);
   this.setVCMap("AV8TrnContext", "vTRNCONTEXT", 0, "WWPBaseObjects\WWPTransactionContext", 0, 0);
   this.Initialize( );
});
gx.wi( function() { gx.createParentObj(academia.lugar);});

/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:23:51.48
*/
gx.evt.autoSkip = false;
gx.define('academia.cursoview', false, function () {
   this.ServerClass =  "academia.cursoview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9CursoId=gx.fn.getIntegerValue("vCURSOID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.CursoGeneral',[this.AV9CursoId]);
      ...
      gx.fn.setCtrlProperty("CELL_NIVEL","Visible", true );
      if ( this.AV10LoadAllTabs || ( this.AV11SelectedTabCode == "Nivel" ) )
      {
         this.createWebComponent('Nivelwc','Academia.CursoNivelWC',[this.AV9CursoId]);
         gx.fn.setCtrlProperty("TXTTABTITLE","Caption", "Nivel" );
         if ( this.AV11SelectedTabCode == "Nivel" )
         {
            gx.fn.setCtrlProperty("CELL_NIVEL","Visible", false );
         }
      }
   };
   ...
   this.e12111_client=function()
   {
      this.clearMessages();
      this.TABSContainer.SelectTab(2) ;
      this.AV11SelectedTabCode =  "Nivel"  ;
      this.AV10LoadAllTabs =  false  ;
      this.s112_client();
      this.refreshOutputs([{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_NIVEL","Visible")',ctrl:'CELL_NIVEL',prop:'Visible'},{ctrl:'NIVELWC'}]);
      return gx.$.Deferred().resolve();
   ...
   TABSContainer.addEventHandler("TabChanged", this.e15111_client);
   ...
   GXValidFnc[28]={ id: 28, fld:"NIVEL_TITLE", format:0,grid:0};
   GXValidFnc[29]={ id: 29, fld:"",grid:0};
   GXValidFnc[31]={ id: 31, fld:"UNNAMEDTABLENIVEL",grid:0};
   ...
   GXValidFnc[42]={ id: 42, fld:"CELL_NIVEL",grid:0};
   GXValidFnc[43]={ id: 43, fld:"BTNNIVEL",grid:0};
   this.AV9CursoId = 0 ;
   this.AV7TabCode = "" ;
   this.A10CursoId = 0 ;
   this.A11CursoNombre = "" ;
   ...
   this.setComponent({id: "NIVELWC" ,GXClass: null , Prefix: "W0034" , lvl: 1 });
});
gx.wi( function() { gx.createParentObj(academia.cursoview);});

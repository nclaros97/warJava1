/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:24:27.94
*/
gx.evt.autoSkip = false;
gx.define('academia.pagoproveedorview', false, function () {
   this.ServerClass =  "academia.pagoproveedorview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9PagoProveedorId=gx.fn.getIntegerValue("vPAGOPROVEEDORID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.PagoProveedorGeneral',[this.AV9PagoProveedorId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e141g1_client);
   ...
   this.setVCMap("AV9PagoProveedorId", "vPAGOPROVEEDORID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.pagoproveedorview);});

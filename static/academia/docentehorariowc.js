/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:10:50.21
*/
gx.evt.autoSkip = false;
gx.define('academia.docentehorariowc', true, function (CmpContext) {
   this.ServerClass =  "academia.docentehorariowc" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV7DocenteId=gx.fn.getIntegerValue("vDOCENTEID",'.') ;
      this.AV7DocenteId=gx.fn.getIntegerValue("vDOCENTEID",'.') ;
      this.AV54Pgmname=gx.fn.getControlValue("vPGMNAME") ;
   };
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",38,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"academia.docentehorariowc",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","Nueva fila",true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   ...
   GRIDPAGINATIONBARContainer.addEventHandler("ChangePage", this.e121w2_client);
   GRIDPAGINATIONBARContainer.addEventHandler("ChangeRowsPerPage", this.e131w2_client);
   ...
   DDO_HORARIOIDContainer.addEventHandler("OnOptionClicked", this.e141w2_client);
   ...
   DDO_HORARIONOMBREContainer.addEventHandler("OnOptionClicked", this.e151w2_client);
   ...
   DDO_HORARIODIASContainer.addEventHandler("OnOptionClicked", this.e161w2_client);
   ...
   DDO_CURSOIDContainer.addEventHandler("OnOptionClicked", this.e171w2_client);
   ...
   DDO_CURSONOMBREContainer.addEventHandler("OnOptionClicked", this.e181w2_client);
   ...
   DDO_NIVELIDContainer.addEventHandler("OnOptionClicked", this.e191w2_client);
   ...
   DDO_NIVELNOMBREContainer.addEventHandler("OnOptionClicked", this.e201w2_client);
   this.setUserControl(DDO_NIVELNOMBREContainer);
   this.DDO_LUGARIDContainer = gx.uc.getNew(this, 72, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_LUGARIDContainer", "Ddo_lugarid", "DDO_LUGARID");
   ...
   DDO_LUGARIDContainer.addV2CFunction('AV43DDO_TitleSettingsIcons', "vDDO_TITLESETTINGSICONS", 'SetDropDownOptionsTitleSettingsIcons');
   DDO_LUGARIDContainer.addC2VFunction(function(UC) { UC.ParentObject.AV43DDO_TitleSettingsIcons=UC.GetDropDownOptionsTitleSettingsIcons();gx.fn.setControlValue("vDDO_TITLESETTINGSICONS",UC.ParentObject.AV43DDO_TitleSettingsIcons); });
   ...
   DDO_LUGARIDContainer.addEventHandler("OnOptionClicked", this.e211w2_client);
   this.setUserControl(DDO_LUGARIDContainer);
   this.DDO_LUGARNOMBREContainer = gx.uc.getNew(this, 74, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_LUGARNOMBREContainer", "Ddo_lugarnombre", "DDO_LUGARNOMBRE");
   ...
   DDO_LUGARNOMBREContainer.addV2CFunction('AV43DDO_TitleSettingsIcons', "vDDO_TITLESETTINGSICONS", 'SetDropDownOptionsTitleSettingsIcons');
   DDO_LUGARNOMBREContainer.addC2VFunction(function(UC) { UC.ParentObject.AV43DDO_TitleSettingsIcons=UC.GetDropDownOptionsTitleSettingsIcons();gx.fn.setControlValue("vDDO_TITLESETTINGSICONS",UC.ParentObject.AV43DDO_TitleSettingsIcons); });
   ...
   DDO_LUGARNOMBREContainer.addEventHandler("OnOptionClicked", this.e221w2_client);
   ...
   DDO_HORARIOFECHAINICIOContainer.addEventHandler("OnOptionClicked", this.e231w2_client);
   ...
   DDO_MANAGEFILTERSContainer.addEventHandler("OnOptionClicked", this.e111w2_client);
   ...
   GXValidFnc[73]={ id:73 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_LUGARIDTITLECONTROLIDTOREPLACE",gxz:"ZV38ddo_LugarIdTitleControlIdToReplace",gxold:"OV38ddo_LugarIdTitleControlIdToReplace",gxvar:"AV38ddo_LugarIdTitleControlIdToReplace",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[75]={ id:75 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_LUGARNOMBRETITLECONTROLIDTOREPLACE",gxz:"ZV40ddo_LugarNombreTitleControlIdToReplace",gxold:"OV40ddo_LugarNombreTitleControlIdToReplace",gxvar:"AV40ddo_LugarNombreTitleControlIdToReplace",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[78]={ id:78 ,lvl:0,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:1,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"DOCENTEID",gxz:"Z12DocenteId",gxold:"O12DocenteId",gxvar:"A12DocenteId",ucs:[],op:[],ip:[],
   ...
   this.setVCMap("AV7DocenteId", "vDOCENTEID", 0, "int", 4, 0);
   this.setVCMap("AV7DocenteId", "vDOCENTEID", 0, "int", 4, 0);
   this.setVCMap("AV54Pgmname", "vPGMNAME", 0, "char", 129, 0);
   this.setVCMap("AV7DocenteId", "vDOCENTEID", 0, "int", 4, 0);
   this.setVCMap("AV54Pgmname", "vPGMNAME", 0, "char", 129, 0);
   ...
   GridContainer.addRefreshingVar({rfrVar:"AV7DocenteId"});

/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:26:44.37
*/
gx.evt.autoSkip = false;
gx.define('academia.pagomatriculaview', false, function () {
   this.ServerClass =  "academia.pagomatriculaview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9PagoMatriculaId=gx.fn.getIntegerValue("vPAGOMATRICULAID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.PagoMatriculaGeneral',[this.AV9PagoMatriculaId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e14231_client);
   ...
   this.setVCMap("AV9PagoMatriculaId", "vPAGOMATRICULAID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.pagomatriculaview);});

/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:24:21.15
*/
gx.evt.autoSkip = false;
gx.define('academia.proveedorview', false, function () {
   this.ServerClass =  "academia.proveedorview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9ProveedorId=gx.fn.getIntegerValue("vPROVEEDORID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.ProveedorGeneral',[this.AV9ProveedorId]);
      ...
      gx.fn.setCtrlProperty("CELL_PAGOPROVEEDOR","Visible", true );
      if ( this.AV10LoadAllTabs || ( this.AV11SelectedTabCode == "PagoProveedor" ) )
      {
         this.createWebComponent('Pagoproveedorwc','Academia.ProveedorPagoProveedorWC',[this.AV9ProveedorId]);
         gx.fn.setCtrlProperty("TXTTABTITLE","Caption", "Pago Proveedor" );
         if ( this.AV11SelectedTabCode == "PagoProveedor" )
         {
            gx.fn.setCtrlProperty("CELL_PAGOPROVEEDOR","Visible", false );
         }
      }
   };
   this.e151a1_client=function()
   {
      this.clearMessages();
      this.AV11SelectedTabCode =  this.TABSContainer.ActivePageControlName  ;
      this.AV10LoadAllTabs =  false  ;
      this.s112_client();
      this.refreshOutputs([{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_PAGOPROVEEDOR","Visible")',ctrl:'CELL_PAGOPROVEEDOR',prop:'Visible'},{ctrl:'PAGOPROVEEDORWC'}]);
      return gx.$.Deferred().resolve();
   };
   this.e111a1_client=function()
   {
      this.clearMessages();
   ...
   this.e121a1_client=function()
   {
      this.clearMessages();
      this.TABSContainer.SelectTab(2) ;
      this.AV11SelectedTabCode =  "PagoProveedor"  ;
      this.AV10LoadAllTabs =  false  ;
      this.s112_client();
      this.refreshOutputs([{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_PAGOPROVEEDOR","Visible")',ctrl:'CELL_PAGOPROVEEDOR',prop:'Visible'},{ctrl:'PAGOPROVEEDORWC'}]);
      return gx.$.Deferred().resolve();
   ...
   TABSContainer.addEventHandler("TabChanged", this.e151a1_client);
   ...
   GXValidFnc[28]={ id: 28, fld:"PAGOPROVEEDOR_TITLE", format:0,grid:0};
   GXValidFnc[29]={ id: 29, fld:"",grid:0};
   GXValidFnc[31]={ id: 31, fld:"UNNAMEDTABLEPAGOPROVEEDOR",grid:0};
   ...
   GXValidFnc[42]={ id: 42, fld:"CELL_PAGOPROVEEDOR",grid:0};
   GXValidFnc[43]={ id: 43, fld:"BTNPAGOPROVEEDOR",grid:0};
   this.AV9ProveedorId = 0 ;
   this.AV7TabCode = "" ;
   this.A28ProveedorId = 0 ;
   this.A62ProveedorNombre = "" ;
   this.AV10LoadAllTabs = false ;
   this.AV11SelectedTabCode = "" ;
   this.Events = {"e161a2_client": ["ENTER", true] ,"e171a2_client": ["CANCEL", true] ,"e151a1_client": ["TABS.TABCHANGED", false] ,"e111a1_client": ["'GENERAL'", false] ,"e121a1_client": ["'PAGOPROVEEDOR'", false]};
   this.EvtParms["REFRESH"] = [[{av:'AV9ProveedorId',fld:'vPROVEEDORID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}],[]];
   this.EvtParms["START"] = [[{av:'A28ProveedorId',fld:'PROVEEDORID',pic:'ZZZ9'},{av:'AV9ProveedorId',fld:'vPROVEEDORID',pic:'ZZZ9',hsh:true},{av:'A62ProveedorNombre',fld:'PROVEEDORNOMBRE',pic:''},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}],[{av:'gx.fn.getCtrlProperty("WORKWITHLINK","Link")',ctrl:'WORKWITHLINK',prop:'Link'},{ctrl:'FORM',prop:'Caption'},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_PAGOPROVEEDOR","Visible")',ctrl:'CELL_PAGOPROVEEDOR',prop:'Visible'},{ctrl:'PAGOPROVEEDORWC'}]];
   this.EvtParms["LOAD"] = [[],[]];
   this.EvtParms["TABS.TABCHANGED"] = [[{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9ProveedorId',fld:'vPROVEEDORID',pic:'ZZZ9',hsh:true}],[{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_PAGOPROVEEDOR","Visible")',ctrl:'CELL_PAGOPROVEEDOR',prop:'Visible'},{ctrl:'PAGOPROVEEDORWC'}]];
   this.EvtParms["'GENERAL'"] = [[{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9ProveedorId',fld:'vPROVEEDORID',pic:'ZZZ9',hsh:true}],[{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_PAGOPROVEEDOR","Visible")',ctrl:'CELL_PAGOPROVEEDOR',prop:'Visible'},{ctrl:'PAGOPROVEEDORWC'}]];
   this.EvtParms["'PAGOPROVEEDOR'"] = [[{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9ProveedorId',fld:'vPROVEEDORID',pic:'ZZZ9',hsh:true}],[{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_PAGOPROVEEDOR","Visible")',ctrl:'CELL_PAGOPROVEEDOR',prop:'Visible'},{ctrl:'PAGOPROVEEDORWC'}]];
   this.setVCMap("AV10LoadAllTabs", "vLOADALLTABS", 0, "boolean", 4, 0);
   this.setVCMap("AV11SelectedTabCode", "vSELECTEDTABCODE", 0, "char", 50, 0);
   this.setVCMap("AV9ProveedorId", "vPROVEEDORID", 0, "int", 4, 0);
   ...
   this.setComponent({id: "PAGOPROVEEDORWC" ,GXClass: null , Prefix: "W0034" , lvl: 1 });
});
gx.wi( function() { gx.createParentObj(academia.proveedorview);});

/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:24:18.68
*/
gx.evt.autoSkip = false;
gx.define('academia.politicaview', false, function () {
   this.ServerClass =  "academia.politicaview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9PoliticaId=gx.fn.getIntegerValue("vPOLITICAID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.PoliticaGeneral',[this.AV9PoliticaId]);
      ...
      {
         this.createWebComponent('Matriculawc','Academia.PoliticaMatriculaWC',[this.AV9PoliticaId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e15141_client);
   ...
   this.AV9PoliticaId = 0 ;
   this.AV7TabCode = "" ;
   this.A26PoliticaId = 0 ;
   this.A41PoliticaNombre = "" ;
   this.AV10LoadAllTabs = false ;
   this.AV11SelectedTabCode = "" ;
   this.Events = {"e16142_client": ["ENTER", true] ,"e17142_client": ["CANCEL", true] ,"e15141_client": ["TABS.TABCHANGED", false] ,"e11141_client": ["'GENERAL'", false] ,"e12141_client": ["'MATRICULA'", false]};
   this.EvtParms["REFRESH"] = [[{av:'AV9PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}],[]];
   this.EvtParms["START"] = [[{av:'A26PoliticaId',fld:'POLITICAID',pic:'ZZZ9'},{av:'AV9PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9',hsh:true},{av:'A41PoliticaNombre',fld:'POLITICANOMBRE',pic:''},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}],[{av:'gx.fn.getCtrlProperty("WORKWITHLINK","Link")',ctrl:'WORKWITHLINK',prop:'Link'},{ctrl:'FORM',prop:'Caption'},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_MATRICULA","Visible")',ctrl:'CELL_MATRICULA',prop:'Visible'},{ctrl:'MATRICULAWC'}]];
   this.EvtParms["LOAD"] = [[],[]];
   this.EvtParms["TABS.TABCHANGED"] = [[{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9',hsh:true}],[{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_MATRICULA","Visible")',ctrl:'CELL_MATRICULA',prop:'Visible'},{ctrl:'MATRICULAWC'}]];
   ...
   this.setVCMap("AV9PoliticaId", "vPOLITICAID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.politicaview);});

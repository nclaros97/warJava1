/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:12:56.79
*/
gx.evt.autoSkip = false;
gx.define('academia.politicamatriculawc', true, function (CmpContext) {
   this.ServerClass =  "academia.politicamatriculawc" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV7PoliticaId=gx.fn.getIntegerValue("vPOLITICAID",'.') ;
      this.AV7PoliticaId=gx.fn.getIntegerValue("vPOLITICAID",'.') ;
      this.AV58Pgmname=gx.fn.getControlValue("vPGMNAME") ;
   };
   ...
   this.e26132_client=function()
   {
      return this.executeServerEvent("'DOINSERT'", false, null, false, false);
   };
   this.e30132_client=function()
   {
      return this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e31132_client=function()
   {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",38,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"academia.politicamatriculawc",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","Nueva fila",true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   ...
   GridContainer.addSingleLineEdit(24,45,"HORARIOID","","","HorarioId","int",0,"px",4,4,"right",null,[],24,"HorarioId",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(18,46,"HORARIONOMBRE","","","HorarioNombre","char",0,"px",50,50,"left",null,[],18,"HorarioNombre",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(20,47,"HORARIOFECHAINICIO","","","HorarioFechaInicio","date",0,"px",8,8,"right",null,[],20,"HorarioFechaInicio",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(10,48,"CURSOID","","","CursoId","int",0,"px",4,4,"right",null,[],10,"CursoId",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(11,49,"CURSONOMBRE","","","CursoNombre","char",0,"px",50,50,"left",null,[],11,"CursoNombre",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(23,50,"NIVELID","","","NivelId","int",0,"px",4,4,"right",null,[],23,"NivelId",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(19,51,"NIVELNOMBRE","","","NivelNombre","char",0,"px",50,50,"left",null,[],19,"NivelNombre",true,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   ...
   GRIDPAGINATIONBARContainer.addEventHandler("ChangePage", this.e12132_client);
   GRIDPAGINATIONBARContainer.addEventHandler("ChangeRowsPerPage", this.e13132_client);
   ...
   DDO_MATRICULAIDContainer.addEventHandler("OnOptionClicked", this.e14132_client);
   ...
   DDO_MATRICULAFECHAContainer.addEventHandler("OnOptionClicked", this.e15132_client);
   this.setUserControl(DDO_MATRICULAFECHAContainer);
   this.DDO_ALUMNOIDContainer = gx.uc.getNew(this, 64, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_ALUMNOIDContainer", "Ddo_alumnoid", "DDO_ALUMNOID");
   ...
   DDO_ALUMNOIDContainer.addV2CFunction('AV47DDO_TitleSettingsIcons', "vDDO_TITLESETTINGSICONS", 'SetDropDownOptionsTitleSettingsIcons');
   DDO_ALUMNOIDContainer.addC2VFunction(function(UC) { UC.ParentObject.AV47DDO_TitleSettingsIcons=UC.GetDropDownOptionsTitleSettingsIcons();gx.fn.setControlValue("vDDO_TITLESETTINGSICONS",UC.ParentObject.AV47DDO_TitleSettingsIcons); });
   ...
   DDO_ALUMNOIDContainer.addEventHandler("OnOptionClicked", this.e16132_client);
   this.setUserControl(DDO_ALUMNOIDContainer);
   this.DDO_ALUMNONOMBREContainer = gx.uc.getNew(this, 66, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_ALUMNONOMBREContainer", "Ddo_alumnonombre", "DDO_ALUMNONOMBRE");
   ...
   DDO_ALUMNONOMBREContainer.addV2CFunction('AV47DDO_TitleSettingsIcons', "vDDO_TITLESETTINGSICONS", 'SetDropDownOptionsTitleSettingsIcons');
   DDO_ALUMNONOMBREContainer.addC2VFunction(function(UC) { UC.ParentObject.AV47DDO_TitleSettingsIcons=UC.GetDropDownOptionsTitleSettingsIcons();gx.fn.setControlValue("vDDO_TITLESETTINGSICONS",UC.ParentObject.AV47DDO_TitleSettingsIcons); });
   ...
   DDO_ALUMNONOMBREContainer.addEventHandler("OnOptionClicked", this.e17132_client);
   this.setUserControl(DDO_ALUMNONOMBREContainer);
   this.DDO_HORARIOIDContainer = gx.uc.getNew(this, 68, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_HORARIOIDContainer", "Ddo_horarioid", "DDO_HORARIOID");
   ...
   DDO_HORARIOIDContainer.addV2CFunction('AV31HorarioIdTitleFilterData', "vHORARIOIDTITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_HORARIOIDContainer.addC2VFunction(function(UC) { UC.ParentObject.AV31HorarioIdTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vHORARIOIDTITLEFILTERDATA",UC.ParentObject.AV31HorarioIdTitleFilterData); });
   DDO_HORARIOIDContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_HORARIOIDContainer.addEventHandler("OnOptionClicked", this.e18132_client);
   this.setUserControl(DDO_HORARIOIDContainer);
   this.DDO_HORARIONOMBREContainer = gx.uc.getNew(this, 70, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_HORARIONOMBREContainer", "Ddo_horarionombre", "DDO_HORARIONOMBRE");
   ...
   DDO_HORARIONOMBREContainer.addV2CFunction('AV33HorarioNombreTitleFilterData', "vHORARIONOMBRETITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_HORARIONOMBREContainer.addC2VFunction(function(UC) { UC.ParentObject.AV33HorarioNombreTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vHORARIONOMBRETITLEFILTERDATA",UC.ParentObject.AV33HorarioNombreTitleFilterData); });
   DDO_HORARIONOMBREContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_HORARIONOMBREContainer.addEventHandler("OnOptionClicked", this.e19132_client);
   this.setUserControl(DDO_HORARIONOMBREContainer);
   this.DDO_HORARIOFECHAINICIOContainer = gx.uc.getNew(this, 72, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_HORARIOFECHAINICIOContainer", "Ddo_horariofechainicio", "DDO_HORARIOFECHAINICIO");
   ...
   DDO_HORARIOFECHAINICIOContainer.addV2CFunction('AV35HorarioFechaInicioTitleFilterData', "vHORARIOFECHAINICIOTITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_HORARIOFECHAINICIOContainer.addC2VFunction(function(UC) { UC.ParentObject.AV35HorarioFechaInicioTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vHORARIOFECHAINICIOTITLEFILTERDATA",UC.ParentObject.AV35HorarioFechaInicioTitleFilterData); });
   DDO_HORARIOFECHAINICIOContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_HORARIOFECHAINICIOContainer.addEventHandler("OnOptionClicked", this.e20132_client);
   this.setUserControl(DDO_HORARIOFECHAINICIOContainer);
   this.DDO_CURSOIDContainer = gx.uc.getNew(this, 74, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_CURSOIDContainer", "Ddo_cursoid", "DDO_CURSOID");
   ...
   DDO_CURSOIDContainer.addV2CFunction('AV37CursoIdTitleFilterData', "vCURSOIDTITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_CURSOIDContainer.addC2VFunction(function(UC) { UC.ParentObject.AV37CursoIdTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vCURSOIDTITLEFILTERDATA",UC.ParentObject.AV37CursoIdTitleFilterData); });
   DDO_CURSOIDContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_CURSOIDContainer.addEventHandler("OnOptionClicked", this.e21132_client);
   this.setUserControl(DDO_CURSOIDContainer);
   this.DDO_CURSONOMBREContainer = gx.uc.getNew(this, 76, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_CURSONOMBREContainer", "Ddo_cursonombre", "DDO_CURSONOMBRE");
   ...
   DDO_CURSONOMBREContainer.addV2CFunction('AV39CursoNombreTitleFilterData', "vCURSONOMBRETITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_CURSONOMBREContainer.addC2VFunction(function(UC) { UC.ParentObject.AV39CursoNombreTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vCURSONOMBRETITLEFILTERDATA",UC.ParentObject.AV39CursoNombreTitleFilterData); });
   DDO_CURSONOMBREContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_CURSONOMBREContainer.addEventHandler("OnOptionClicked", this.e22132_client);
   this.setUserControl(DDO_CURSONOMBREContainer);
   this.DDO_NIVELIDContainer = gx.uc.getNew(this, 78, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_NIVELIDContainer", "Ddo_nivelid", "DDO_NIVELID");
   ...
   DDO_NIVELIDContainer.addV2CFunction('AV41NivelIdTitleFilterData', "vNIVELIDTITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_NIVELIDContainer.addC2VFunction(function(UC) { UC.ParentObject.AV41NivelIdTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vNIVELIDTITLEFILTERDATA",UC.ParentObject.AV41NivelIdTitleFilterData); });
   DDO_NIVELIDContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_NIVELIDContainer.addEventHandler("OnOptionClicked", this.e23132_client);
   this.setUserControl(DDO_NIVELIDContainer);
   this.DDO_NIVELNOMBREContainer = gx.uc.getNew(this, 80, 32, "BootstrapDropDownOptions", this.CmpContext + "DDO_NIVELNOMBREContainer", "Ddo_nivelnombre", "DDO_NIVELNOMBRE");
   ...
   DDO_NIVELNOMBREContainer.addV2CFunction('AV43NivelNombreTitleFilterData', "vNIVELNOMBRETITLEFILTERDATA", 'SetDropDownOptionsData');
   DDO_NIVELNOMBREContainer.addC2VFunction(function(UC) { UC.ParentObject.AV43NivelNombreTitleFilterData=UC.GetDropDownOptionsData();gx.fn.setControlValue("vNIVELNOMBRETITLEFILTERDATA",UC.ParentObject.AV43NivelNombreTitleFilterData); });
   DDO_NIVELNOMBREContainer.setC2ShowFunction(function(UC) { UC.show(); });
   DDO_NIVELNOMBREContainer.addEventHandler("OnOptionClicked", this.e24132_client);
   ...
   DDO_MATRICULAAPROBADOContainer.addEventHandler("OnOptionClicked", this.e25132_client);
   ...
   DDO_MANAGEFILTERSContainer.addEventHandler("OnOptionClicked", this.e11132_client);
   ...
   GXValidFnc[65]={ id:65 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE",gxz:"ZV28ddo_AlumnoIdTitleControlIdToReplace",gxold:"OV28ddo_AlumnoIdTitleControlIdToReplace",gxvar:"AV28ddo_AlumnoIdTitleControlIdToReplace",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[67]={ id:67 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE",gxz:"ZV30ddo_AlumnoNombreTitleControlIdToReplace",gxold:"OV30ddo_AlumnoNombreTitleControlIdToReplace",gxvar:"AV30ddo_AlumnoNombreTitleControlIdToReplace",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[69]={ id:69 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_HORARIOIDTITLECONTROLIDTOREPLACE",gxz:"ZV32ddo_HorarioIdTitleControlIdToReplace",gxold:"OV32ddo_HorarioIdTitleControlIdToReplace",gxvar:"AV32ddo_HorarioIdTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV32ddo_HorarioIdTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV32ddo_HorarioIdTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_HORARIOIDTITLECONTROLIDTOREPLACE",gx.O.AV32ddo_HorarioIdTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV32ddo_HorarioIdTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_HORARIOIDTITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   GXValidFnc[71]={ id:71 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE",gxz:"ZV34ddo_HorarioNombreTitleControlIdToReplace",gxold:"OV34ddo_HorarioNombreTitleControlIdToReplace",gxvar:"AV34ddo_HorarioNombreTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV34ddo_HorarioNombreTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV34ddo_HorarioNombreTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE",gx.O.AV34ddo_HorarioNombreTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV34ddo_HorarioNombreTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   GXValidFnc[73]={ id:73 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE",gxz:"ZV36ddo_HorarioFechaInicioTitleControlIdToReplace",gxold:"OV36ddo_HorarioFechaInicioTitleControlIdToReplace",gxvar:"AV36ddo_HorarioFechaInicioTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV36ddo_HorarioFechaInicioTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV36ddo_HorarioFechaInicioTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE",gx.O.AV36ddo_HorarioFechaInicioTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV36ddo_HorarioFechaInicioTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   GXValidFnc[75]={ id:75 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_CURSOIDTITLECONTROLIDTOREPLACE",gxz:"ZV38ddo_CursoIdTitleControlIdToReplace",gxold:"OV38ddo_CursoIdTitleControlIdToReplace",gxvar:"AV38ddo_CursoIdTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV38ddo_CursoIdTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV38ddo_CursoIdTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_CURSOIDTITLECONTROLIDTOREPLACE",gx.O.AV38ddo_CursoIdTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV38ddo_CursoIdTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_CURSOIDTITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   GXValidFnc[77]={ id:77 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE",gxz:"ZV40ddo_CursoNombreTitleControlIdToReplace",gxold:"OV40ddo_CursoNombreTitleControlIdToReplace",gxvar:"AV40ddo_CursoNombreTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV40ddo_CursoNombreTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV40ddo_CursoNombreTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE",gx.O.AV40ddo_CursoNombreTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV40ddo_CursoNombreTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   GXValidFnc[79]={ id:79 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_NIVELIDTITLECONTROLIDTOREPLACE",gxz:"ZV42ddo_NivelIdTitleControlIdToReplace",gxold:"OV42ddo_NivelIdTitleControlIdToReplace",gxvar:"AV42ddo_NivelIdTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV42ddo_NivelIdTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV42ddo_NivelIdTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_NIVELIDTITLECONTROLIDTOREPLACE",gx.O.AV42ddo_NivelIdTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV42ddo_NivelIdTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_NIVELIDTITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   GXValidFnc[81]={ id:81 ,lvl:0,type:"svchar",len:300,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE",gxz:"ZV44ddo_NivelNombreTitleControlIdToReplace",gxold:"OV44ddo_NivelNombreTitleControlIdToReplace",gxvar:"AV44ddo_NivelNombreTitleControlIdToReplace",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV44ddo_NivelNombreTitleControlIdToReplace=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV44ddo_NivelNombreTitleControlIdToReplace=Value},v2c:function(){gx.fn.setControlValue("vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE",gx.O.AV44ddo_NivelNombreTitleControlIdToReplace,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV44ddo_NivelNombreTitleControlIdToReplace=this.val()},val:function(){return gx.fn.getControlValue("vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE")},nac:gx.falseFn};
   ...
   GXValidFnc[84]={ id:84 ,lvl:0,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:1,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"POLITICAID",gxz:"Z26PoliticaId",gxold:"O26PoliticaId",gxvar:"A26PoliticaId",ucs:[],op:[],ip:[],
   ...
   this.AV32ddo_HorarioIdTitleControlIdToReplace = "" ;
   this.ZV32ddo_HorarioIdTitleControlIdToReplace = "" ;
   this.OV32ddo_HorarioIdTitleControlIdToReplace = "" ;
   this.AV34ddo_HorarioNombreTitleControlIdToReplace = "" ;
   this.ZV34ddo_HorarioNombreTitleControlIdToReplace = "" ;
   this.OV34ddo_HorarioNombreTitleControlIdToReplace = "" ;
   this.AV36ddo_HorarioFechaInicioTitleControlIdToReplace = "" ;
   this.ZV36ddo_HorarioFechaInicioTitleControlIdToReplace = "" ;
   this.OV36ddo_HorarioFechaInicioTitleControlIdToReplace = "" ;
   this.AV38ddo_CursoIdTitleControlIdToReplace = "" ;
   this.ZV38ddo_CursoIdTitleControlIdToReplace = "" ;
   this.OV38ddo_CursoIdTitleControlIdToReplace = "" ;
   this.AV40ddo_CursoNombreTitleControlIdToReplace = "" ;
   this.ZV40ddo_CursoNombreTitleControlIdToReplace = "" ;
   this.OV40ddo_CursoNombreTitleControlIdToReplace = "" ;
   this.AV42ddo_NivelIdTitleControlIdToReplace = "" ;
   this.ZV42ddo_NivelIdTitleControlIdToReplace = "" ;
   this.OV42ddo_NivelIdTitleControlIdToReplace = "" ;
   this.AV44ddo_NivelNombreTitleControlIdToReplace = "" ;
   this.ZV44ddo_NivelNombreTitleControlIdToReplace = "" ;
   this.OV44ddo_NivelNombreTitleControlIdToReplace = "" ;
   ...
   this.Events = {"e12132_client": ["GRIDPAGINATIONBAR.CHANGEPAGE", true] ,"e13132_client": ["GRIDPAGINATIONBAR.CHANGEROWSPERPAGE", true] ,"e14132_client": ["DDO_MATRICULAID.ONOPTIONCLICKED", true] ,"e15132_client": ["DDO_MATRICULAFECHA.ONOPTIONCLICKED", true] ,"e16132_client": ["DDO_ALUMNOID.ONOPTIONCLICKED", true] ,"e17132_client": ["DDO_ALUMNONOMBRE.ONOPTIONCLICKED", true] ,"e18132_client": ["DDO_HORARIOID.ONOPTIONCLICKED", true] ,"e19132_client": ["DDO_HORARIONOMBRE.ONOPTIONCLICKED", true] ,"e20132_client": ["DDO_HORARIOFECHAINICIO.ONOPTIONCLICKED", true] ,"e21132_client": ["DDO_CURSOID.ONOPTIONCLICKED", true] ,"e22132_client": ["DDO_CURSONOMBRE.ONOPTIONCLICKED", true] ,"e23132_client": ["DDO_NIVELID.ONOPTIONCLICKED", true] ,"e24132_client": ["DDO_NIVELNOMBRE.ONOPTIONCLICKED", true] ,"e25132_client": ["DDO_MATRICULAAPROBADO.ONOPTIONCLICKED", true] ,"e11132_client": ["DDO_MANAGEFILTERS.ONOPTIONCLICKED", true] ,"e26132_client": ["'DOINSERT'", true] ,"e30132_client": ["ENTER", true] ,"e31132_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'sPrefix'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{ctrl:'GRID',prop:'Rows'}],[{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["START"] = [[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}],[{ctrl:'GRID',prop:'Rows'},{av:'gx.fn.getCtrlProperty("vMANAGEFILTERSEXECUTIONSTEP","Visible")',ctrl:'vMANAGEFILTERSEXECUTIONSTEP',prop:'Visible'},{av:'this.DDO_MATRICULAIDContainer.TitleControlIdToReplace',ctrl:'DDO_MATRICULAID',prop:'TitleControlIdToReplace'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_MATRICULAFECHAContainer.TitleControlIdToReplace',ctrl:'DDO_MATRICULAFECHA',prop:'TitleControlIdToReplace'},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_ALUMNOIDContainer.TitleControlIdToReplace',ctrl:'DDO_ALUMNOID',prop:'TitleControlIdToReplace'},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_ALUMNONOMBREContainer.TitleControlIdToReplace',ctrl:'DDO_ALUMNONOMBRE',prop:'TitleControlIdToReplace'},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_HORARIOIDContainer.TitleControlIdToReplace',ctrl:'DDO_HORARIOID',prop:'TitleControlIdToReplace'},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_HORARIOIDTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_HORARIONOMBREContainer.TitleControlIdToReplace',ctrl:'DDO_HORARIONOMBRE',prop:'TitleControlIdToReplace'},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_HORARIOFECHAINICIOContainer.TitleControlIdToReplace',ctrl:'DDO_HORARIOFECHAINICIO',prop:'TitleControlIdToReplace'},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_CURSOIDContainer.TitleControlIdToReplace',ctrl:'DDO_CURSOID',prop:'TitleControlIdToReplace'},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_CURSOIDTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_CURSONOMBREContainer.TitleControlIdToReplace',ctrl:'DDO_CURSONOMBRE',prop:'TitleControlIdToReplace'},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_NIVELIDContainer.TitleControlIdToReplace',ctrl:'DDO_NIVELID',prop:'TitleControlIdToReplace'},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_NIVELIDTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_NIVELNOMBREContainer.TitleControlIdToReplace',ctrl:'DDO_NIVELNOMBRE',prop:'TitleControlIdToReplace'},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'this.DDO_MATRICULAAPROBADOContainer.TitleControlIdToReplace',ctrl:'DDO_MATRICULAAPROBADO',prop:'TitleControlIdToReplace'},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'gx.fn.getCtrlProperty("vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE","Visible")',ctrl:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',prop:'Visible'},{av:'gx.fn.getCtrlProperty("POLITICAID","Visible")',ctrl:'POLITICAID',prop:'Visible'},{av:'gx.fn.getCtrlProperty("vORDEREDBY","Visible")',ctrl:'vORDEREDBY',prop:'Visible'},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'gx.fn.getCtrlProperty("vORDEREDDSC","Visible")',ctrl:'vORDEREDDSC',prop:'Visible'},{av:'this.DDO_MANAGEFILTERSContainer.Icon',ctrl:'DDO_MANAGEFILTERS',prop:'Icon'},{av:'AV47DDO_TitleSettingsIcons',fld:'vDDO_TITLESETTINGSICONS',pic:''},{av:'this.GRIDPAGINATIONBARContainer.RowsPerPageSelectedValue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]];
   this.EvtParms["GRIDPAGINATIONBAR.CHANGEPAGE"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.GRIDPAGINATIONBARContainer.SelectedPage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}],[]];
   this.EvtParms["GRIDPAGINATIONBAR.CHANGEROWSPERPAGE"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.GRIDPAGINATIONBARContainer.RowsPerPageSelectedValue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}],[{ctrl:'GRID',prop:'Rows'}]];
   this.EvtParms["DDO_MATRICULAID.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_MATRICULAIDContainer.ActiveEventKey',ctrl:'DDO_MATRICULAID',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_MATRICULAIDContainer.SortedStatus',ctrl:'DDO_MATRICULAID',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_MATRICULAFECHA.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_MATRICULAFECHAContainer.ActiveEventKey',ctrl:'DDO_MATRICULAFECHA',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_MATRICULAFECHAContainer.SortedStatus',ctrl:'DDO_MATRICULAFECHA',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_ALUMNOID.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_ALUMNOIDContainer.ActiveEventKey',ctrl:'DDO_ALUMNOID',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_ALUMNOIDContainer.SortedStatus',ctrl:'DDO_ALUMNOID',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_ALUMNONOMBRE.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_ALUMNONOMBREContainer.ActiveEventKey',ctrl:'DDO_ALUMNONOMBRE',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_ALUMNONOMBREContainer.SortedStatus',ctrl:'DDO_ALUMNONOMBRE',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_HORARIOID.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_HORARIOIDContainer.ActiveEventKey',ctrl:'DDO_HORARIOID',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_HORARIOIDContainer.SortedStatus',ctrl:'DDO_HORARIOID',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_HORARIONOMBRE.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_HORARIONOMBREContainer.ActiveEventKey',ctrl:'DDO_HORARIONOMBRE',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_HORARIONOMBREContainer.SortedStatus',ctrl:'DDO_HORARIONOMBRE',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_HORARIOFECHAINICIO.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_HORARIOFECHAINICIOContainer.ActiveEventKey',ctrl:'DDO_HORARIOFECHAINICIO',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_HORARIOFECHAINICIOContainer.SortedStatus',ctrl:'DDO_HORARIOFECHAINICIO',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_CURSOID.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_CURSOIDContainer.ActiveEventKey',ctrl:'DDO_CURSOID',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_CURSOIDContainer.SortedStatus',ctrl:'DDO_CURSOID',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_CURSONOMBRE.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_CURSONOMBREContainer.ActiveEventKey',ctrl:'DDO_CURSONOMBRE',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_CURSONOMBREContainer.SortedStatus',ctrl:'DDO_CURSONOMBRE',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_NIVELID.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_NIVELIDContainer.ActiveEventKey',ctrl:'DDO_NIVELID',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_NIVELIDContainer.SortedStatus',ctrl:'DDO_NIVELID',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_NIVELNOMBRE.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_NIVELNOMBREContainer.ActiveEventKey',ctrl:'DDO_NIVELNOMBRE',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_NIVELNOMBREContainer.SortedStatus',ctrl:'DDO_NIVELNOMBRE',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["DDO_MATRICULAAPROBADO.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_MATRICULAAPROBADOContainer.ActiveEventKey',ctrl:'DDO_MATRICULAAPROBADO',prop:'ActiveEventKey'}],[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'this.DDO_MATRICULAAPROBADOContainer.SortedStatus',ctrl:'DDO_MATRICULAAPROBADO',prop:'SortedStatus'},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]];
   this.EvtParms["GRID.LOAD"] = [[{av:'A27MatriculaId',fld:'MATRICULAID',pic:'ZZZ9',hsh:true},{av:'A1AlumnoId',fld:'ALUMNOID',pic:'ZZZ9'},{av:'A24HorarioId',fld:'HORARIOID',pic:'ZZZ9'},{av:'A10CursoId',fld:'CURSOID',pic:'ZZZ9'}],[{av:'AV54Update',fld:'vUPDATE',pic:''},{av:'gx.fn.getCtrlProperty("vUPDATE","Link")',ctrl:'vUPDATE',prop:'Link'},{av:'AV55Delete',fld:'vDELETE',pic:''},{av:'gx.fn.getCtrlProperty("vDELETE","Link")',ctrl:'vDELETE',prop:'Link'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Link")',ctrl:'MATRICULAFECHA',prop:'Link'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Link")',ctrl:'ALUMNONOMBRE',prop:'Link'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Link")',ctrl:'HORARIONOMBRE',prop:'Link'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Link")',ctrl:'CURSONOMBRE',prop:'Link'}]];
   this.EvtParms["DDO_MANAGEFILTERS.ONOPTIONCLICKED"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV7PoliticaId',fld:'vPOLITICAID',pic:'ZZZ9'},{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24ddo_MatriculaIdTitleControlIdToReplace',fld:'vDDO_MATRICULAIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_MatriculaFechaTitleControlIdToReplace',fld:'vDDO_MATRICULAFECHATITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_AlumnoIdTitleControlIdToReplace',fld:'vDDO_ALUMNOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_AlumnoNombreTitleControlIdToReplace',fld:'vDDO_ALUMNONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV32ddo_HorarioIdTitleControlIdToReplace',fld:'vDDO_HORARIOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV34ddo_HorarioNombreTitleControlIdToReplace',fld:'vDDO_HORARIONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV36ddo_HorarioFechaInicioTitleControlIdToReplace',fld:'vDDO_HORARIOFECHAINICIOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV38ddo_CursoIdTitleControlIdToReplace',fld:'vDDO_CURSOIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_CursoNombreTitleControlIdToReplace',fld:'vDDO_CURSONOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV42ddo_NivelIdTitleControlIdToReplace',fld:'vDDO_NIVELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_NivelNombreTitleControlIdToReplace',fld:'vDDO_NIVELNOMBRETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_MatriculaAprobadoTitleControlIdToReplace',fld:'vDDO_MATRICULAAPROBADOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'this.DDO_MANAGEFILTERSContainer.ActiveEventKey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}],[{av:'AV17ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV23MatriculaIdTitleFilterData',fld:'vMATRICULAIDTITLEFILTERDATA',pic:''},{av:'AV25MatriculaFechaTitleFilterData',fld:'vMATRICULAFECHATITLEFILTERDATA',pic:''},{av:'AV27AlumnoIdTitleFilterData',fld:'vALUMNOIDTITLEFILTERDATA',pic:''},{av:'AV29AlumnoNombreTitleFilterData',fld:'vALUMNONOMBRETITLEFILTERDATA',pic:''},{av:'AV31HorarioIdTitleFilterData',fld:'vHORARIOIDTITLEFILTERDATA',pic:''},{av:'AV33HorarioNombreTitleFilterData',fld:'vHORARIONOMBRETITLEFILTERDATA',pic:''},{av:'AV35HorarioFechaInicioTitleFilterData',fld:'vHORARIOFECHAINICIOTITLEFILTERDATA',pic:''},{av:'AV37CursoIdTitleFilterData',fld:'vCURSOIDTITLEFILTERDATA',pic:''},{av:'AV39CursoNombreTitleFilterData',fld:'vCURSONOMBRETITLEFILTERDATA',pic:''},{av:'AV41NivelIdTitleFilterData',fld:'vNIVELIDTITLEFILTERDATA',pic:''},{av:'AV43NivelNombreTitleFilterData',fld:'vNIVELNOMBRETITLEFILTERDATA',pic:''},{av:'AV45MatriculaAprobadoTitleFilterData',fld:'vMATRICULAAPROBADOTITLEFILTERDATA',pic:''},{ctrl:'MATRICULAID',prop:'Titleformat',hsh:true},{av:'gx.fn.getCtrlProperty("MATRICULAID","Title")',ctrl:'MATRICULAID',prop:'Title'},{ctrl:'MATRICULAFECHA',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAFECHA","Title")',ctrl:'MATRICULAFECHA',prop:'Title'},{ctrl:'ALUMNOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNOID","Title")',ctrl:'ALUMNOID',prop:'Title'},{ctrl:'ALUMNONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("ALUMNONOMBRE","Title")',ctrl:'ALUMNONOMBRE',prop:'Title'},{ctrl:'HORARIOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOID","Title")',ctrl:'HORARIOID',prop:'Title'},{ctrl:'HORARIONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIONOMBRE","Title")',ctrl:'HORARIONOMBRE',prop:'Title'},{ctrl:'HORARIOFECHAINICIO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("HORARIOFECHAINICIO","Title")',ctrl:'HORARIOFECHAINICIO',prop:'Title'},{ctrl:'CURSOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSOID","Title")',ctrl:'CURSOID',prop:'Title'},{ctrl:'CURSONOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("CURSONOMBRE","Title")',ctrl:'CURSONOMBRE',prop:'Title'},{ctrl:'NIVELID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELID","Title")',ctrl:'NIVELID',prop:'Title'},{ctrl:'NIVELNOMBRE',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("NIVELNOMBRE","Title")',ctrl:'NIVELNOMBRE',prop:'Title'},{ctrl:'MATRICULAAPROBADO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("MATRICULAAPROBADO","Title")',ctrl:'MATRICULAAPROBADO',prop:'Title'},{av:'AV50GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV21ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]];
   ...
   this.setVCMap("AV7PoliticaId", "vPOLITICAID", 0, "int", 4, 0);
   this.setVCMap("AV7PoliticaId", "vPOLITICAID", 0, "int", 4, 0);
   this.setVCMap("AV58Pgmname", "vPGMNAME", 0, "char", 129, 0);
   this.setVCMap("AV7PoliticaId", "vPOLITICAID", 0, "int", 4, 0);
   this.setVCMap("AV58Pgmname", "vPGMNAME", 0, "char", 129, 0);
   ...
   GridContainer.addRefreshingVar({rfrVar:"AV7PoliticaId"});

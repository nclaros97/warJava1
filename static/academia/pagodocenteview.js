/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:26:44.92
*/
gx.evt.autoSkip = false;
gx.define('academia.pagodocenteview', false, function () {
   this.ServerClass =  "academia.pagodocenteview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9PagoDocenteId=gx.fn.getIntegerValue("vPAGODOCENTEID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.PagoDocenteGeneral',[this.AV9PagoDocenteId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e14261_client);
   ...
   this.setVCMap("AV9PagoDocenteId", "vPAGODOCENTEID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.pagodocenteview);});

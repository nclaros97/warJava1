/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:24:26.23
*/
gx.evt.autoSkip = false;
gx.define('academia.politicapagodocentesview', false, function () {
   this.ServerClass =  "academia.politicapagodocentesview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9PoliticaPagoDocenteId=gx.fn.getIntegerValue("vPOLITICAPAGODOCENTEID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.PoliticaPagoDocentesGeneral',[this.AV9PoliticaPagoDocenteId]);
      ...
      {
         this.createWebComponent('Horariowc','Academia.PoliticaPagoDocentesHorarioWC',[this.AV9PoliticaPagoDocenteId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e151d1_client);
   ...
   this.AV9PoliticaPagoDocenteId = 0 ;
   this.AV7TabCode = "" ;
   this.A32PoliticaPagoDocenteId = 0 ;
   this.A49PoliticaPagoDocenteValor = 0 ;
   this.AV10LoadAllTabs = false ;
   this.AV11SelectedTabCode = "" ;
   this.Events = {"e161d2_client": ["ENTER", true] ,"e171d2_client": ["CANCEL", true] ,"e151d1_client": ["TABS.TABCHANGED", false] ,"e111d1_client": ["'GENERAL'", false] ,"e121d1_client": ["'HORARIO'", false]};
   this.EvtParms["REFRESH"] = [[{av:'AV9PoliticaPagoDocenteId',fld:'vPOLITICAPAGODOCENTEID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}],[]];
   this.EvtParms["START"] = [[{av:'A32PoliticaPagoDocenteId',fld:'POLITICAPAGODOCENTEID',pic:'ZZZ9'},{av:'AV9PoliticaPagoDocenteId',fld:'vPOLITICAPAGODOCENTEID',pic:'ZZZ9',hsh:true},{av:'A49PoliticaPagoDocenteValor',fld:'POLITICAPAGODOCENTEVALOR',pic:'ZZZZ9.99'},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}],[{av:'gx.fn.getCtrlProperty("WORKWITHLINK","Link")',ctrl:'WORKWITHLINK',prop:'Link'},{ctrl:'FORM',prop:'Caption'},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_HORARIO","Visible")',ctrl:'CELL_HORARIO',prop:'Visible'},{ctrl:'HORARIOWC'}]];
   this.EvtParms["LOAD"] = [[],[]];
   this.EvtParms["TABS.TABCHANGED"] = [[{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9PoliticaPagoDocenteId',fld:'vPOLITICAPAGODOCENTEID',pic:'ZZZ9',hsh:true}],[{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_HORARIO","Visible")',ctrl:'CELL_HORARIO',prop:'Visible'},{ctrl:'HORARIOWC'}]];
   ...
   this.setVCMap("AV9PoliticaPagoDocenteId", "vPOLITICAPAGODOCENTEID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.politicapagodocentesview);});

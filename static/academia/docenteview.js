/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:26:43.65
*/
gx.evt.autoSkip = false;
gx.define('academia.docenteview', false, function () {
   this.ServerClass =  "academia.docenteview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9DocenteId=gx.fn.getIntegerValue("vDOCENTEID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.DocenteGeneral',[this.AV9DocenteId]);
      ...
      {
         this.createWebComponent('Horariowc','Academia.DocenteHorarioWC',[this.AV9DocenteId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e151x1_client);
   ...
   this.Events = {"e161x2_client": ["ENTER", true] ,"e171x2_client": ["CANCEL", true] ,"e151x1_client": ["TABS.TABCHANGED", false] ,"e111x1_client": ["'GENERAL'", false] ,"e121x1_client": ["'HORARIO'", false]};
   this.EvtParms["REFRESH"] = [[{av:'AV9DocenteId',fld:'vDOCENTEID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}],[]];
   this.EvtParms["START"] = [[{av:'A12DocenteId',fld:'DOCENTEID',pic:'ZZZ9'},{av:'AV9DocenteId',fld:'vDOCENTEID',pic:'ZZZ9',hsh:true},{av:'A14DocenteNombre',fld:'DOCENTENOMBRE',pic:''},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}],[{av:'gx.fn.getCtrlProperty("WORKWITHLINK","Link")',ctrl:'WORKWITHLINK',prop:'Link'},{ctrl:'FORM',prop:'Caption'},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_HORARIO","Visible")',ctrl:'CELL_HORARIO',prop:'Visible'},{ctrl:'HORARIOWC'}]];
   this.EvtParms["LOAD"] = [[],[]];
   this.EvtParms["TABS.TABCHANGED"] = [[{av:'this.TABSContainer.ActivePageControlName',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9DocenteId',fld:'vDOCENTEID',pic:'ZZZ9',hsh:true}],[{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'gx.fn.getCtrlProperty("CELL_GENERAL","Visible")',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'gx.fn.getCtrlProperty("TXTTABTITLE","Caption")',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'gx.fn.getCtrlProperty("CELL_HORARIO","Visible")',ctrl:'CELL_HORARIO',prop:'Visible'},{ctrl:'HORARIOWC'}]];
   ...
   this.setVCMap("AV9DocenteId", "vDOCENTEID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.docenteview);});

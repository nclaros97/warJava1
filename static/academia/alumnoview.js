/*!   GeneXus Java 16_0_1-129648 on November 1, 2019 22:26:43.43
*/
gx.evt.autoSkip = false;
gx.define('academia.alumnoview', false, function () {
   this.ServerClass =  "academia.alumnoview" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV9AlumnoId=gx.fn.getIntegerValue("vALUMNOID",'.') ;
   ...
   this.s112_client=function()
   {
      ...
      {
         this.createWebComponent('Generalwc','Academia.AlumnoGeneral',[this.AV9AlumnoId]);
      ...
      {
         this.createWebComponent('Matriculawc','Academia.AlumnoMatriculaWC',[this.AV9AlumnoId]);
   ...
   TABSContainer.addEventHandler("TabChanged", this.e15201_client);
   ...
   this.setVCMap("AV9AlumnoId", "vALUMNOID", 0, "int", 4, 0);
...
gx.wi( function() { gx.createParentObj(academia.alumnoview);});
